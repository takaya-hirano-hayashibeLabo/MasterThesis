\section{実験1: 入力速度変化に対する内部状態変化の検証}
...
CNN構造における入出力のサイズは, チャンネル数 $\times$ 高さ $\times$ 幅を表す.
...
\begin{table}[htb]
    ...
    \begin{tabular}{cccc}
        ...
        \hline
        1   & Conv2d & $1 \times 2 \times 2$ & $4 \times 2 \times 2$ \\
        2 & AveragePooling2d & $4 \times 2 \times 2$ & $4 \times 1 \times 1$ \\
        3 & Conv2d & $4 \times 1 \times 1$ & $8 \times 1 \times 1$ \\
        5 & Linear & $8$ & $4$ \\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[htb]
    ...
    \begin{tabular}{cccc}
        ...
        1   & Conv2d & $1 \times 2 \times 2$ & $4 \times 2 \times 2$ \\
        2 & AveragePooling2d & $4 \times 2 \times 2$ & $4 \times 1 \times 1$ \\
        3 & Dropout ($dr=0.3$) & $4 \times 1 \times 1$ & $4 \times 1 \times 1$ \\
        4 & Conv2d & $4 \times 1 \times 1$ & $8 \times 1 \times 1$ \\
...
\begin{table}[htb]
    ...
    \begin{tabular}{cccc}
        ...
        \hline
        1   & Conv2d & $1 \times 2 \times 2$ & $4 \times 2 \times 2$ \\
        2 & BatchNormalization & $4 \times 2 \times 2$ & $4 \times 2 \times 2$ \\
        3 & AveragePooling2d & $4 \times 2 \times 2$ & $4 \times 1 \times 1$ \\
        4 & Conv2d & $4 \times 1 \times 1$ & $8 \times 1 \times 1$ \\
...
\begin{table}[htb]
    ...
    \begin{tabular}{ccccc}
        ...
        \hline
        1   & MS-ResNet & $1 \times 2 \times 2$ & $4 \times 2 \times 2$ & 2\\
        2 & AveragePooling2d & $4 \times 2 \times 2$ & $4 \times 1 \times 1$ & - \\
        3 & MS-ResNet & $4 \times 1 \times 1$ & $8 \times 1 \times 1$ & 2\\
        4 & AveragePooling2d & $8 \times 1 \times 1$ & $8 \times 1 \times 1$ & - \\
        5 & Linear & 8 & 4 & - \\
        \hline
    \end{tabular}
\end{table}
